...
//*chr:�ַ�����ʼ��ַ 
//mode:0,��ɫ��ʾ;1,������ʾ
void OLED_ShowString(u8 x,u8 y,const u8 *chr,u8 size1,u8 mode)
{
...
//		nexttemp = (num/OLED_Pow(10,len-t))%10;
			if((temp != 0)&&(one2zero == 0))
				one2zero = 1;
...
void OLED_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(OLED_SDA_RCC, ENABLE);	 
